...
public class GameData {
    ...
    System.out.println(" In" + " " + Game2.getReleaseDate() + " " + "\"" + Game2.getGameTitle() + "\"" + " was released." + "It sold"+ " " + Game2.getAmountSold() + " " + "copies." + " The game genre was" + " " + Game2.getGenre() + ".");
    System.out.println (" The Developers were" + " " + "\"" + Game2.getDeveloper() + "\"" + "." + " " + "\"" + Game2.getPublisher() +"\""+ " " + "published the game." );
    }
}
